...
async function downloadEnvelopeDocument(envelopeId, documentId = '1') {
  ...
  return envelopesApi.getDocument(process.env.DOCUSIGN_ACCOUNT_ID, envelopeId, documentId);
}

module.exports = { isConfigured, getAccessToken, getAuthorizedApiClient, downloadEnvelopeDocument, consentUrl };
