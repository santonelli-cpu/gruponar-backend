...
// Envoltura visual de todos los correos — mismos colores/tipografías que
// public/shared.css (oxblood/stone/Cormorant Garamond+Inter), simplificado a
// lo que soportan bien los clientes de correo (nada de CSS variables ni
// grid/flex).
...
<body style="margin:0; padding:0; background:#F6F4F0; font-family:Georgia, 'Times New Roman', serif;">
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#F6F4F0; padding:32px 16px;">
    <tr><td align="center">
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:520px; background:#FFFFFF; border-radius:14px; overflow:hidden; border:1px solid rgba(33,22,19,0.12);">
        <tr><td style="background:#3A0C08; padding:22px 28px;">
          <div style="font-family:Georgia, 'Times New Roman', serif; font-size:20px; color:#F6F4F0; font-weight:600; letter-spacing:0.3px;">Grupo Nar</div>
          <div style="font-family:Arial, sans-serif; font-size:11px; color:#D8B9B4; letter-spacing:1.5px; text-transform:uppercase; margin-top:2px;">Coordinación de cierres</div>
        </td></tr>
        <tr><td style="padding:28px 28px 8px;">
          <div style="font-family:Georgia, 'Times New Roman', serif; font-size:19px; color:#3A0C08; font-weight:600; margin-bottom:14px;">${title}</div>
          <div style="font-family:Arial, sans-serif; font-size:14px; line-height:1.6; color:#211613;">${bodyHtml}</div>
        </td></tr>
        ${ctaUrl ? `
        <tr><td style="padding:8px 28px 28px;">
          <a href="${ctaUrl}" style="display:inline-block; background:#58130E; color:#FFFFFF; text-decoration:none; font-family:Arial, sans-serif; font-size:13.5px; font-weight:bold; padding:11px 22px; border-radius:24px;">${ctaLabel || 'Ver'}</a>
        </td></tr>` : ''}
        <tr><td style="padding:16px 28px; border-top:1px solid rgba(33,22,19,0.12); font-family:Arial, sans-serif; font-size:11px; color:#A79A94;">
